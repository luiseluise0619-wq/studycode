...
| 영역 | 규모 | 설명 |
|---|---|---|
| **지식 엔진** | 32트랙 · 2,454문항 | Python 705 / SQL 572 중심. choice·input·code(라이브 실행) 문제 |
...
**주력** Python 705 · SQL 572 · Git/DevOps 98 · 보안 64 · 백엔드 58 · 시스템 설계 50
**언어** JavaScript 117 · Java 98 · C 67 · C++ 66 · Go 53 · React 20
**데이터/AI** Pandas 45 · NumPy 45 · 통계 45 · 머신러닝 45 · ML평가 45 · 딥러닝 45
**CS/기타** HTML/CSS 73 · 알고리즘 18 · OS 16 · 아두이노 16 · 그 외 8씩
