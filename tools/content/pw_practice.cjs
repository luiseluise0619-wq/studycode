...
const SQL4 = require("./sql_fourth.js");
...
const OPS2 = require("./devops_second.js");
const SYSD2 = require("./sysd_second.js");
const SEC2 = require("./sec_second.js");
const NET2 = require("./net_second.js");
const OS2 = require("./os_second.js");
const FP = require("./fp_first.js");
const MATH = require("./math_first.js");
const BE4 = require("./be_fourth.js");
const OPS3 = require("./ops_third.js");
const REACT4 = require("./react_fourth.js");
const BE5 = require("./be_fifth.js");
...
(async () => {
  ...
  const items = flat(JS, "js").concat(flat(ALGO, "js")).concat(flat(JSMID, "js")).concat(flat(JSASYNC, "js")).concat(flat(JS3, "js")).concat(flat(BE3, "js")).concat(flat(OPS2, "js")).concat(flat(SYSD2, "js")).concat(flat(SEC2, "js")).concat(flat(NET2, "js")).concat(flat(OS2, "js")).concat(flat(FP, "js")).concat(flat(MATH, "js")).concat(flat(BE4, "js")).concat(flat(OPS3, "js")).concat(flat(BE5, "js")).concat(flat(SQL, "sql")).concat(flat(SQL2, "sql")).concat(flat(SQL3, "sql")).concat(flat(SQL4, "sql")).concat(flat(WEB, "html")).concat(flat(WEB2, "html")).concat(flat(REACT, "react")).concat(flat(REACTA, "react")).concat(flat(REACT3, "react")).concat(flat(REACT4, "react"));
