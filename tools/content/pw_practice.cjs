...
(async () => {
  ...
  const items = flat(JS, "js").concat(flat(ALGO, "js")).concat(flat(JSMID, "js")).concat(flat(JSASYNC, "js")).concat(flat(JS3, "js")).concat(flat(BE3, "js")).concat(flat(OPS2, "js")).concat(flat(SQL, "sql")).concat(flat(SQL2, "sql")).concat(flat(SQL3, "sql")).concat(flat(WEB, "html")).concat(flat(WEB2, "html")).concat(flat(REACT, "react")).concat(flat(REACTA, "react")).concat(flat(REACT3, "react"));
